...
public class DefaultCache<K, V> implements Cache<K, V> {
     ...
     */
    protected org.gaixie.jibu.cache.LinkedList lastAccessedList;

    /**
     * Linked list to maintain time that cache objects were initially added
     * to the cache, most recently added to oldest added.
     */
    protected org.gaixie.jibu.cache.LinkedList ageList;
    ...
    public DefaultCache(String name, long maxSize, long maxLifetime) {
        ...
        lastAccessedList = new org.gaixie.jibu.cache.LinkedList();
        ageList = new org.gaixie.jibu.cache.LinkedList();
    }
    ...
    public synchronized V put(K key, V value) {
            ...
            if (maxCacheSize > 0 && objectSize > maxCacheSize * .90) {
                logger.warn("Cache: " + name + " -- object with key " + key +
